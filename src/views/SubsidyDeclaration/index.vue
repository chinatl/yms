<template>
    <div>
            ...
            <div class="box-item-form">
                <el-form :inline="true" :model="formInline" label-width="160px" :rules="formInlineRules" ref="formInline">
                    <el-form-item label="义务兵姓名：" prop="csmanName">
                        <el-input v-model.trim="formInline.csmanName" placeholder="请输入义务兵姓名" size="medium" maxlength="20"></el-input>
                    </el-form-item>
                    <el-form-item label="义务兵身份证：" prop="csmanIdcard">
                        <el-input v-model.trim="formInline.csmanIdcard" placeholder="请输入义务兵身份证" size="medium" maxlength="18"></el-input>
                    </el-form-item>
                    <el-form-item label="义务兵通知书号：" prop="csmanNoticeNo">
                        <el-input v-model.trim="formInline.csmanNoticeNo" placeholder="请输入义务兵通知书号" size="medium" maxlength="20"></el-input>
                    </el-form-item>
                    <el-form-item label="义务兵所在学校："  prop="csmanSchool">
                        <el-input v-model.trim="formInline.csmanSchool" placeholder="请输入义务兵所在学校" size="medium" maxlength="20"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item prop="addressDetail" ref="addressDetail">
                        <el-input v-model.trim="formInline.addressDetail" placeholder="请输入更详细的街道地址" size="medium" maxlength="50"></el-input>
                    </el-form-item>                  
                </el-form>
            </div>
        </div>
            ...
            <div class="box-item-form">
                <el-form :inline="true" :model="user_form"  label-width="160px" :rules="user_form_rules" ref="user_form">
                    <el-form-item label="领取人姓名：" prop="receiptorName">
                        <el-input v-model.trim="user_form.receiptorName" placeholder="请输入领取人姓名" size="medium" maxlength="20"></el-input>
                    </el-form-item>
                    <el-form-item label="领取人身份证：" prop="receiptorIdcard">
                        <el-input v-model.trim="user_form.receiptorIdcard" placeholder="请输入领取人身份证" size="medium" maxlength="18"></el-input>
                    </el-form-item>
                    <el-form-item label="联系电话：" prop="receiptorPhone">
                        <el-input v-model.trim="user_form.receiptorPhone" placeholder="请输入联系电话" size="medium" maxlength="20"></el-input>
                    </el-form-item>
                    <el-form-item label="银行卡号：" prop="account">
                        <el-input v-model.number.trim="user_form.account" placeholder="请输入银行卡号" size="medium" maxlength="20"></el-input>
                    </el-form-item>
                </el-form>
            </div>
        </div>
        <div class="box-item">
            ...
            <div class="box-item-form">
                <upload-file bgc='身份证正'  info='点击拍摄身份证正面' title="上传身份证正面照片" :data='idcardFrontPhotoId' @upload='upload1' @remove='idcardFrontPhotoId.src = ""'></upload-file> 
                <upload-file bgc='身份证反'  info='点击拍摄身份证反面' title="上传身份证反面照片" :data='idcardBackPhotoId' @upload='upload2'  @remove='idcardBackPhotoId.src = ""'></upload-file> 
                <upload-file bgc='人物照片'  info='点击拍摄办理人照片' title="上传办理人照片"     :data='transactorPhotoId' @upload='upload3'  @remove='transactorPhotoId.src = ""'></upload-file> 
                <upload-file bgc='通知书例'  info='点击拍摄义务兵入伍通知书' title="上传义务兵入伍通知书照片" :data='csmanNoticePhotoId' @upload='upload4' @remove='csmanNoticePhotoId.src = ""'></upload-file> 
                <upload-file bgc='人物照片'  info='点击拍摄义务兵户口本' title="上传义务兵户口本照片" :data='csmanHukouPhotoId' @upload='upload5' @remove='csmanHukouPhotoId.src = ""'></upload-file>
            </div>
        </div>
