    ...
    <el-dialog
      ...
      <div class="user-info">
        ...
        <p>
          <span>补助类别：</span>
          <span
            class="red">{{getType(user_data.PREFERENTIAL_TREATMENT_TYPE,user_data.EDUCATION,user_data.ARMS_TYPE)}}</span>
        </p>
        <p>
          <span>补助账号：</span>
        ...
        <p>
          <span>发放时间：</span>
          <span class="red">{{user_data.GRANT_TIME | formatDate('yyyy-MM-dd hh:mm')}}</span>
        </p>
      </div>
