    ...
    <div>
         <div class="box-item">
            ...
            <div class="table-content ">
                <el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
                    <el-table-column prop="CSMAN_NAME" align='center' label="义务兵姓名"></el-table-column>
                    <el-table-column prop="RECEIPTOR_NAME" align='center' label="领取人姓名"></el-table-column>
                    ...
                    <el-table-column prop="GRANT_MONEY" align='center' label="发放金额"></el-table-column>
                    <el-table-column prop="GRANT_DURATION" align='center' label="发放时长"></el-table-column>
                    ...
                    <el-table-column prop="GRANT_TIME" align='center' label="发放时间"></el-table-column>
        ...
        <el-dialog
            ...
            <div class="user-info">
                ...
                <p>
                    <span>补助类别：</span>
                    <span class="red">{{getType(user_data.PREFERENTIAL_TREATMENT_TYPE,user_data.EDUCATION,user_data.ARMS_TYPE)}}</span>
                </p>
                <p>
                    <span>补助账号：</span>
                ...
                <p>
                    <span>补助时长：</span>
                    <span class="red">{{user_data.SUBSIDY_DURATION}}</span>
                </p>
                <p>
                    <span>补助标准：</span>
                    <span class="red">{{user_data.STANDARD_AMOUNT}}</span>
                </p>
                <p>
                    <span>增发金额：</span>
                    <span class="red">{{user_data.INCREASE_MONEY}}</span>
                </p>
                <p>
                    <span>补助总额：</span>
                    <span class="red">{{user_data.GRANT_MONEY}}</span>
                </p>
                <p>
                    <span>发放机构：</span>
